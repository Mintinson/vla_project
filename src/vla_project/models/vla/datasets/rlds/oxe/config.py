...
from vla_project.models.vla.datasets.rlds.oxe.utils.droid_utils import zero_action_filter


# Defines Proprioceptive State Encoding Schemes
class StateEncoding(IntEnum):
    """Defines the different types of proprioceptive state encodings."""
...
class ActionEncoding(IntEnum):
    """Defines the different types of action encodings."""
