...
from vla_project.models.vla.datasets import EpisodicRLDSDataset, RLDSBatchTransform, RLDSDataset
from vla_project.utils.data_utils import PaddedCollatorForActionPrediction
...
def get_vla_dataset_and_collator(
    ...
    *,
    ...
    collator = PaddedCollatorForActionPrediction(
        ...
        tokenizer.pad_token_id,  # pyright: ignore[reportArgumentType]
