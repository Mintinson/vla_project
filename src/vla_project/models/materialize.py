...
from vla_project.models.backbones.llm import LLMBackbone, PhiLLMBackbone
from vla_project.models.backbones.vision import (
    DinoV2ViTBackbone,
    VisionBackbone,
)
...
VISION_BACKBONES = {
    ...
    "dinov2-vit-s": {"cls": DinoV2ViTBackbone, "kwargs": {"default_image_size": 224}},
...
def get_vision_backbone_and_transform(
    ...
    msg = f"Vision Backbone `{vision_backbone_id}` is not supported!"
...
def get_llm_backbone_and_tokenizer(
    ...
    *,
    ...
    msg = f"LLM Backbone `{llm_backbone_id}` is not supported!"
    raise ValueError(msg)


def get_vlm(
    model_id: str,
    arch_specifier: Literal["linear", "fused-gelu-mlp", "gelu-mlp"],
